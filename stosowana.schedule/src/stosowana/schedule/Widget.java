...
public class Widget extends AppWidgetProvider {
	...
	/**
	 * Przy okazji update'u widgetu sprawdzamy czy nie jest pusty a po
	 * sprawdzeniu wersji wywołujemy odpowiednią funkcję updatującą dla każdej
	 * instancji widgetu (ktoś mógł ich dodać kilka)
	 */
	...
	/**
	 * Dla starszych wersji ręcznie tworzymy widok 'listy' i wypełniamy pola dla
	 * każdego przedmiotu
	 */
	...
	/**
	 * Wypełnienie widoku dla nowszych wersji poprzez ustawienie adaptera
	 * (RemoteViewsProvider to obudowany adapter) dla ListView za pomocą
	 * WidgetService. Adapter pobiera dane, tworzy i zwraca widoki (RemoteViews)
	 * automatycznie pobierane przy wypełnianiu listy.
	 */
	@TargetApi(12)
	...
	public static void add(int parseInt, Subject subject, Context context) {
//		tu jest na sztywno wpisana lokacja plikówz takiego powodu, że nie można się dobrać do context
		Log.d(TAG,"add");
		if (schedule == null)
			DataFetchActivity.loadData(new File(context.getFilesDir().getPath() + "/schedule"));
